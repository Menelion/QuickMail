...
public class RuleServiceTests
{
    ...
    public async Task ApplyRulesAsync_DisabledRule_Skipped()
    {
        ...
        try
        {
            ...
            var count = await svc.ApplyRulesAsync(msgs, accountId, CancellationToken.None);
    ...
    public async Task ApplyRulesAsync_WrongAccount_Skipped()
    {
        ...
        try
        {
            ...
            var count = await svc.ApplyRulesAsync(msgs, otherAccountId, CancellationToken.None);
            Assert.Equal(0, count);
        }
        finally { if (Directory.Exists(dir)) Directory.Delete(dir, true); }
    }
